...
ActiveRecord::Schema.define(version: 20200403172903) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "amuse_parks", force: :cascade do |t|
    t.string "name"
    t.float "price"
  ...
  create_table "rides", force: :cascade do |t|
    t.string "name"
    t.integer "rating"
    t.bigint "amuse_park_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["amuse_park_id"], name: "index_rides_on_amuse_park_id"
  end

  add_foreign_key "mechanic_rides", "mechanics"
  add_foreign_key "mechanic_rides", "rides"
  add_foreign_key "rides", "amuse_parks"
end
